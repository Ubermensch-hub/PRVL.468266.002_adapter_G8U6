...
/* Private typedef -----------------------------------------------------------*/
/* USER CODE BEGIN PTD */
typedef enum AdapterState {PWR_OFF = 0x00, PWR_ON = 0x03, REBOOT = 0x01, HARD_RESET = 0x02} AdapterState;
...
/* USER CODE BEGIN PFP */
AdapterState State = PWR_OFF;
GPIO_PinState MB_State = GPIO_PIN_SET;
PWROKState PWR_OK_State = GPIO_PIN_SET;
/* USER CODE END PFP */
  ...
  if (State != state)
	  {
		  ...
		  case PWR_ON:
			  ...
			  HAL_GPIO_WritePin(MB_STATUS_LED_GPIO_Port, MB_STATUS_LED_Pin, GPIO_PIN_RESET);
			  PressButton();
			  HAL_Delay(300);
			  SetPWROK(LOW);
			  HAL_Delay(5000);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MB_BITCH_Pin|MCU_HOS_ON_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : MB_STATUS_LED_Pin */
  GPIO_InitStruct.Pin = MB_STATUS_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(MB_STATUS_LED_GPIO_Port, &GPIO_InitStruct);
